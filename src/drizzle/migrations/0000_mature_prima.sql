...
CREATE TABLE "job_info" (
	...
	"title" varchar,
	"name" varchar NOT NULL,
	"experience" "job_info_experience_level" NOT NULL,
...
ALTER TABLE "questions" ADD CONSTRAINT "questions_jobInfoId_job_info_id_fk" FOREIGN KEY ("jobInfoId") REFERENCES "public"."job_info"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
